...
const AttestationEduTime = () => {
  return (
    <div className="atteEduTimeContainer">
      <h2>
        Total time period to get Degree Certificate Attestation in Bangalore:
      </h2>
...
export default AttestationEduTime;
