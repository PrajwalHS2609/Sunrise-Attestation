...
const AustraliaBloreMain = () => {
  return (
    ...
    <p>
      ...
      work, or do business. Australia attestation of the document is a significant
      procedure that is to be performed mostly if you are planning to visit
      the Australia. Australia embassy attestation is a process of getting a signature or
      stamp on a document by the authorized department.
    </p>
    <p>
      It is generally required for attaining an education, family, &
      employment visa of Australia. Certificate attestation for Australia is needed to
