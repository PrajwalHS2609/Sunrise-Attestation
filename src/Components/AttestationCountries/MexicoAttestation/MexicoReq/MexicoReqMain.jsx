    ...
    <div className="uaeReqMainContainer">
      <div className="uaeReqMainContent">
        ...
        <p>
          ...
          need documents with the MEA sticker to sanction a visitor to enter
          their country. It is a part of the evidence that signifies the
