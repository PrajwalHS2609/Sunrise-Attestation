      ...
      <Accordion className="faqMainContent" allowZeroExpanded>
        <AccordionItem className="faqItem" data-aos="fade-right">
          ...
          <AccordionItemPanel className="faqPanel">
            <p>
              Saudi Arabia attestation is the process of authenticating
              documents issued in India for use in Saudi Arabia. This involves
              getting them validated by relevant Indian authorities and the
              Saudi Embassy.
            </p>
          </AccordionItemPanel>
        </AccordionItem>
        <AccordionItem className="faqItem" data-aos="fade-right">
          <AccordionItemHeading className="faqHead">
            <AccordionItemButton className="faqBut">
              <h3>Why do I need Saudi Arabia  attestation ?</h3>
            </AccordionItemButton>
          </AccordionItemHeading>
          <AccordionItemPanel className="faqPanel">
            <p>
            Saudi Arabia  attestation is necessary for legalizing documents such as
          ...
          <AccordionItemPanel className="faqPanel">
            <p>
              <ul>
                ...
                <li>Saudi Embassy Attestation</li>
              </ul>
            </p>
          </AccordionItemPanel>
        </AccordionItem>
        ...
        <AccordionItem className="faqItem" data-aos="fade-right">
          <AccordionItemHeading className="faqHead">
            <AccordionItemButton className="faqBut">
              <h3>What are the charges for Saudi Arabia  attestation services ?</h3>
            </AccordionItemButton>
          </AccordionItemHeading>
          <AccordionItemPanel className="faqPanel">
            <p>
              The charges for Saudi Arabia  attestation vary depending on the type of
        ...
        <AccordionItem className="faqItem" data-aos="fade-right">
          ...
          <AccordionItemPanel className="faqPanel">
            <p>
              ...
              State HRD, MEA, and finally the Saudi Embassy.
            </p>
          </AccordionItemPanel>
        </AccordionItem>
        <AccordionItem className="faqItem" data-aos="fade-right">
