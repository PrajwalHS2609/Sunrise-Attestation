...
const UkBloreMain = () => {
  return (
    <div className="uaeBloreMainContainer">
      <p>
        UK is one of the well-known nations that welcome foreigners to live,
        work, or do business. UK attestation of the document is a significant
        procedure that is to be performed mostly if you are planning to visit
        the UK. UK embassy attestation is a process of getting a signature or
        stamp on a document by the authorized department.
      </p>
      <p>
        It is generally required for attaining an education, family, &
        employment visa of UK. Certificate attestation for UK is needed to prove
        its authenticity for usage in the UK. You can get UK certificate
