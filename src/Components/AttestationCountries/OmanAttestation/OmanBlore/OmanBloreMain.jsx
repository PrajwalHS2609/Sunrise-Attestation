  ...
  return (
    <div className="uaeBloreMainContainer">
      <p>
        ...
        work, or do business. Oman apostille of the document is a significant
        procedure that is to be performed mostly if you are planning to visit
        the Oman. Oman embassy apostille is a process of getting a signature or
        stamp on a document by the authorized department.
      </p>
      <p>
        It is generally required for attaining an education, family, &
        employment visa of Oman. Certificate apostille for Oman is needed to
