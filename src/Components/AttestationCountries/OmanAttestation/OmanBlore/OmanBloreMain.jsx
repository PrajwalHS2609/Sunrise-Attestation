...
const OmanBloreMain = () => {
  return (
    <div className="uaeBloreMainContainer">
      <p>
        Oman is one of the well-known nations that welcome foreigners to live,
        work, or do business. Oman attestation of the document is a significant
        procedure that is to be performed mostly if you are planning to visit
        the Oman. Oman embassy attestation is a process of getting a signature or
        stamp on a document by the authorized department.
      </p>
      <p>
        It is generally required for attaining an education, family, &
        employment visa of Oman. Certificate attestation for Oman is needed to
        prove its authenticity for usage in the Oman. You can get Oman certificate
