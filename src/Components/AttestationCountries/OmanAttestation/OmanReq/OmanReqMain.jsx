    ...
    <div className="uaeReqMainContainer">
      <div className="uaeReqMainContent">
        ...
        <p>
          ...
          to permit a visitor to stay or perform business in their nation. It is
          a part of security in order to prove the authenticity of the
          documents. Therefore, the validation of documents becomes important
          for these reasons.
        </p>
      </div>
      <div className="uaeReqMainContent">
