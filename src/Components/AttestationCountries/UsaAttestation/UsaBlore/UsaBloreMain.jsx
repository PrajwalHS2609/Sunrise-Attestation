...
const UsaBloreMain = () => {
  return (
    <div className="uaeBloreMainContainer">
      <p>
        USA is one of the well-known nations that welcome foreigners to live,
        work, or do business. USA attestation of the document is a significant
        procedure that is to be performed mostly if you are planning to visit
        the USA. USA embassy attestation is a process of getting a signature or
        stamp on a document by the authorized department.
      </p>
      <p>
        It is generally required for attaining an education, family, &
        employment visa of USA. Certificate attestation for USA is needed to
        prove its authenticity for usage in the USA. You can get USA certificate
