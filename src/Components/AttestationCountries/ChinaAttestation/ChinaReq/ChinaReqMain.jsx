    ...
    <div className="uaeReqMainContainer">
      <div className="uaeReqMainContent">
        ...
        <p>
          ...
          several causes such as student visa, work visa, residence visa, or for
          business aspects. It is a part of the evidence that shows that you are
          a legitimate person or company. It proves that your certificates are
          genuine & can be permitted in the nation.
        </p>
      </div>
      <div className="uaeReqMainContent">
        ...
        <p>
          ...
          for, or the types of documents, or the authority you need it from.
          Generally, it will take around 15 days to 25 days to accomplish the
          whole process.
        </p>
      </div>
    </div>
