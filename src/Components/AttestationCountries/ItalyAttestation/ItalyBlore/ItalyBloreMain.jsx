...
const ItalyBloreMain = () => {
  return (
    <div className="uaeBloreMainContainer">
      <p>
        Italy is one of the well-known nations that welcome foreigners to live,
        work, or do business. Italy attestation of the document is a significant
        procedure that is to be performed mostly if you are planning to visit
        the Italy. Italy embassy attestation is a process of getting a signature
        or stamp on a document by the authorized department.
      </p>
      <p>
        It is generally required for attaining an education, family, &
        employment visa of Italy. Certificate attestation for Italy is needed to
        prove its authenticity for usage in the Italy. You can get Italy
